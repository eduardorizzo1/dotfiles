# Generated by Powerlevel10k configuration wizard on 2023-04-03 at 11:44 -03.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19454.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# round separators, round heads, round tails, 2 lines, disconnected, no frame, light-ornaments,sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_EMPTY_LINE_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL= 
	...
	# ROUNDED 2
	# typeset -g POWERLEVEL9K_{LEFT,RIGHT}_LEFT_WHITESPACE='%S%F{#171A1B}\uE0B6%s'
 	# typeset -g POWERLEVEL9K_{LEFT,RIGHT}_RIGHT_WHITESPACE='%S%F{#171A1B}\uE0B4%s'
  ...
  # typeset -g POWERLEVEL9K_DIR_BACKGROUND=#422fa3
  # Default current directory foreground color.
  # typeset -g POWERLEVEL9K_DIR_FOREGROUND=#fff
