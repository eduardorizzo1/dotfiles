...
Singleton {
    ...
    // property real workpaceTransparency: 0.9
    property string background_image: "~/.config/hypr/wallpapers/15.png"
    
    m3colors: QtObject {
        // property bool darkmode: true
        // property bool transparent: false

        property color m3windowBackground: "#1a1b26"
        property color m3primaryText: "#c0caf5"
        property color m3layerBackground1: "#1a1b26"
        ...
        property color m3borderPrimary: "#7aa2ff"
        property color m3shadowColor: "#000000"
        property color m3accentPrimary: "#7aa2ff"
        ...
        property color m3borderSecondary: "#7dcfff"
    ...
    font: QtObject {
        property QtObject family: QtObject {
            property string uiFont: "Cascadia Code"
            property string iconFont: "Hack Nerd Font"
            property string codeFont: "JetBrains Mono NF"
        }
        property QtObject pixelSize: QtObject {
            property int textSmall: 15
            property int textBase: 17
            property int textMedium: 18
            property int textLarge: 20
